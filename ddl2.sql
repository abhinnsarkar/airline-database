...
CREATE TABLE public.seat_allocation (
    ...
    -- FOREIGN KEY (flight_id, departure_date, departure_time) REFERENCES public.flight_schedule(flight_id, departure_date, departure_time)
);

CREATE TABLE public.ticket (
    ticket_id UUID PRIMARY KEY,
    customer_id UUID NOT NULL,
    -- flight_id UUID NOT NULL,  the flight id will come from the schdule id
    flight_schedule_id UUID NOT NULL,
